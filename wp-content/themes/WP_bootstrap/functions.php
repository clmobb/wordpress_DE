...
function show_comments($comment, $args, $depth) {   // show_comments = callback Funktion in comments.php array
...
//              printf(__('%1$s um %2$s Uhr:'), get_comment_date(), get_comment_time());
            echo '</div>';
